  ...
  describe NotifyAPI do
    describe "Notify message" do
      it "Successful notification" do
        ...
        NotifyAPI.notify("token", "Hello, World!", boundary: boundary)
      end
    end
    ...
    describe "Notify image file with url" do
      it "Successful notification" do
        ...
        NotifyAPI.notify("token", "Hello, World!", img_file: "http://example.com/orig.jpg", boundary: boundary)
      end
    end
    ...
    describe "Notify image file with local file path" do
      it "Successful notification" do
        ...
        body += "\r\n\r\n"
        File.open("./spec/line/img/hello_world.jpg") do |file|
        ...
        NotifyAPI.notify("token", "Hello, World!", img_file: "./spec/line/img/hello_world.jpg", boundary: boundary)
      end
    end
    ...
    describe "Notify thmbnail" do
      it "Successful notification" do
        ...
        NotifyAPI.notify("token", "Hello, World!", thumbnail: "http://example.com/img_thmb.jpg", boundary: boundary)
      end
    end
    ...
    describe "Notify sticker" do
      it "Successful notification" do
        ...
        NotifyAPI.notify("token", "Hello, World!", stk_pkg_id: 1, stk_id: 2, boundary: boundary)
      end
    end
    ...
    describe "Notify thumbnail and image file and sticker" do
      it "Successful notification" do
        ...
        NotifyAPI.notify("token", "Hello, World!", thumbnail: "http://example.com/tmb.jpg", img_file: "http://example.com/orig.jpg", stk_pkg_id: 1, stk_id: 2, boundary: boundary)
      end
    end
  end
end
